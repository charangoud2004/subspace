...
def _resolve_with_hunter(contact: dict[str, str], api_key: str, base_url: str) -> str:
    """Resolve one contact email through Hunter.io using domain plus first and last name."""
...
def resolve_emails(contacts: list[dict[str, str]]) -> list[dict[str, str]]:
    """Given contacts with names and domains, return contacts enriched with Hunter.io emails."""
